<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/241095143/23.1.4%2B)
...
2. Subscribe to the [`ASPxClientDashboard.BeforeRender`](https://docs.devexpress.com/Dashboard/js-DevExpress.Dashboard.Web.WebForms.ASPxClientDashboard#js_aspxclientdashboard_beforerender) event. 
